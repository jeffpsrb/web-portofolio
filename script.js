...
function initContactForm() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // Create mailto link
            const mailtoLink = `mailto:jeffreypasaribu.jobs@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key === 'Enter' || e.key === ' ') {
        ...
        if (activeElement.classList.contains('social-link') || 
